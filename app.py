...
print(crop_recommendation_model)
...
def predict_image(img, model=disease_model):
    ...
    # Check if the image is smaller than 256x256 pixels
...
def crop_recommend():
    title = 'Agri World - Crop Recommendation'
...
def fertilizer_recommendation():
    title = 'Agri World - Fertilizer Suggestion'

    return render_template('fertilizer.html', title=title)

# render tools and technology page
@ app.route('/tools')
def tools_technology():
    title='Tools And Technology'
    return render_template('latesttools.html',title=title)
...
def disease_prediction():
    title = 'Agri World - Disease Detection'
